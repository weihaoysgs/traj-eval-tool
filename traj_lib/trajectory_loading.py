...
import traj_lib.associate_timestamps as associ
...
def load_stamped_dataset_from_file(gt_traj_file_path, estimate_traj_file_path, max_diff=0.02):
    
    fn_es = estimate_traj_file_path
    fn_gt = gt_traj_file_path
